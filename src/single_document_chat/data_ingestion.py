...
class SingleDocIngestion:
    def __init__(self,data_dir:str="data/single_document_chat",faiss_dir:str="faiss_index"):
        try:
            ...
            self.log.error("Failed to initialize SingleDocIngestion", error=str(e))
            raise DocumentPortalException("Initialization error in SingleDocIngestion",sys) 
    ...
    def _create_retriever(self,documents):
        try:
            ...
            self.log.info("Retriver created successfully", retriever_type=str(type(retriver)))
            return retriver
