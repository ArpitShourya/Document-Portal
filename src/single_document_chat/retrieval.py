...
class ConversationalRAG:
    def __init__(self,session_id:str,retriever):
        try:
            ...
            self.log.error("Error initializing ConversationRAG", error=str(e), session_id=self.session_id)
            raise DocumentPortalException("Failed to initialize ConverstionRAG")
